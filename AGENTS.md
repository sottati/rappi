...
- `DETALLE_PEDIDO` debe tratarse como snapshot transaccional del item comprado, no como dependencia operacional del catalogo vigente: guardar id del producto de catalogo, nombre, cantidad y precio unitario de cierre.
