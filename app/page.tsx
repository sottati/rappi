    ...
    <main className="min-h-svh bg-background text-foreground">
      ...
      <section className="mx-auto grid min-h-svh w-full max-w-6xl content-center gap-8 px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="space-y-6">
          <div>
            <h2 className="mb-3 text-sm font-semibold">Home categorías</h2>
            <div className="flex gap-4 overflow-x-auto rounded-xl border bg-card p-4">
              {homeCategories.map((item) => (
                <div key={item.label} className="flex shrink-0 flex-col items-center gap-2">
          ...
          <div>
            <h2 className="mb-3 text-sm font-semibold">Categorías de tiendas</h2>
            <div className="flex gap-4 overflow-x-auto rounded-xl border bg-card p-4">
              {storeCategories.map((item) => (
                <div key={item.label} className="flex shrink-0 flex-col items-center gap-2">
                  ...
                  <img
                    src={item.src}
                    alt={item.label}
                    className="size-[72px] rounded-lg object-contain"
                  />
          ...
          <div>
            <h2 className="mb-3 text-sm font-semibold">Categorías de comidas</h2>
            <div className="flex flex-wrap gap-4 overflow-x-auto rounded-xl border bg-card p-4">
